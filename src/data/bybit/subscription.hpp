...
struct ByBitSubscription
{
    ...
    bool IsReady() const
    { return dataManager && dataManager->GetDataProvider(symbol)->IsReadyHandleData(); }

    void Handle(const SubscriptionTopic& topic, const std::string& type, const glz::json_t& payload)
